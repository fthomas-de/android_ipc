...
class AccessibilityNodeProviderCompat$AccessibilityNodeProviderKitKatImpl$1 implements android.support.v4.view.accessibility.AccessibilityNodeProviderCompatKitKat$AccessibilityNodeInfoBridge
{
    ...
    AccessibilityNodeProviderCompat$AccessibilityNodeProviderKitKatImpl$1(AccessibilityNodeProviderCompat$AccessibilityNodeProviderKitKatImpl  r1, AccessibilityNodeProviderCompat  r2)
    {
    ...
    public Object findFocus(int  i0)
    {

        AccessibilityNodeInfoCompat r2;
        Object r3;
        r2 = val$compat.findFocus(i0);
